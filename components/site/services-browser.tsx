          ...
          <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_230px]">
            ...
            <label className="lg:hidden">
              ...
              <select
                ...
                className="h-14 w-full rounded-[8px] border border-brand-navy/14 bg-white px-4 text-sm font-semibold text-brand-ink outline-none focus:border-brand-gold/55"
              >
          ...
          <div className="mt-8 divide-y divide-brand-navy/10 border-y border-brand-navy/12">
            {filtered.map((service, index) => (
              <Link
                ...
                className="group grid gap-5 py-6 md:grid-cols-[56px_minmax(0,1fr)_190px_28px] md:items-center"
              >
                ...
                <div className="min-w-0">
                  ...
                  <h2 className="mt-2 text-xl font-semibold leading-[1.15] tracking-[-0.03em] text-brand-ink sm:text-2xl">
                    {service.title}
                  </h2>
                  <p className="mt-2 line-clamp-2 text-sm leading-6 text-brand-muted">{service.shortDescription}</p>
                </div>

                <div className="grid grid-cols-2 gap-4 text-xs md:block md:text-right">
                  <div>
