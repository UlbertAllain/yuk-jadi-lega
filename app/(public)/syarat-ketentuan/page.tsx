  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-16 lg:px-8 lg:py-24">
      ...
      <div className="mt-10 space-y-8 text-sm leading-8 text-slate-600">
        <section>
          <h2 className="text-lg font-semibold text-slate-950">Informasi di website</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-950">Konsultasi dan pemesanan</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-950">Dokumen dan data</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-950">Perubahan ketentuan</h2>
          <p className="mt-2">
