    ...
    <main>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 lg:px-8 lg:py-20">
        <div className="space-y-10 text-sm leading-8 text-slate-700">
          <section>
            <h2 className="text-xl font-black text-slate-950">1. Informasi yang kami terima</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950">2. Penggunaan informasi</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950">3. Penyimpanan dan perlindungan data</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950">4. Layanan pihak ketiga</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950">5. Pertanyaan tentang privasi</h2>
            <p className="mt-3">
